...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    def update( self , instance , validated_data):
        """ Update recipe ... note instance is used because we are upddating the specified validated data with the instance"""
...
class RecipeImageSerializer(serializers.ModelSerializer):
    """
    Serializer for uploading images to reecipes  .
    """
