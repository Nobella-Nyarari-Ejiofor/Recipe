...
def create_recipe(user, **params):
    """
    Create and return a sampple recipe
    """
    defaults = {
...
class PublicRecipeApiTesrs(TestCase):
    """
    ...
    def test_auth_required(self):
        """
        test that auth is required to cal API
        """
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """
        Test retrirving a list of frecipes
        """
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user = self.user ,
            title = 'Sample recipe title',
            link = 'https://example1.com/recipe.pdf',
    ...
    def test_update_user_returns_error(self):
        ...
        """
        new_user = create_user(email = 'user3@example.com' , password ='passs3')
        recipe = create_recipe(user = self.user)
    ...
    def test_recipe_others_users_recipe_errors(self):
        """
        Test trying to delete other user recipe gives error
        """
        new_user = create_user(email = 'newuser@gmail.com', password = 'newpass123')
    ...
    def test_create_recipe_with_new_ingredients(self):
        """
        Test for creating arecipe with a new ingredient
        """
        payload = {
    ...
    def test_create_recipe_with_existing_ingredients(self):
        """
        Test for creating a recipe with an existing ingredient
        """
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user = self.user , title  = 'Banana Bread')
        ingredient1 = Ingredient.objects.create(user = self.user , name ='Feta Cheese')
        ingredient2 = Ingredient.objects.create (user = self.user ,name = 'Chicken Broth')
...
class ImageUploadTests(TestCase):
    ...
    def tearDown(self):
        """
        process that runs after every test unlike setUp which runs before a test.
        Why? no need to build unneccesary images
        """
    ...
    def test_upload_image_bad_rrequest(self):
        """
